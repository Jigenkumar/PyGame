...
def plot_snake(snk_list):
    snake = pygame.image.load("Static/Snake.png")
...
#BackGround
bgimg = pygame.image.load("Static/BackGround.jpg")
bgimg = pygame.transform.scale(bgimg, (900, 500)).convert_alpha()
wcimg = pygame.image.load("Static/welcome.jpg")
wcimg = pygame.transform.scale(wcimg, (900, 500)).convert_alpha()
goimg = pygame.image.load("Static/gameover.png")
    ...
    while not exit_game:
        if game_over:
            ...
            if abs(snake_x-food_x)<10 and abs(snake_y-food_y)<10:
                pygame.mixer.music.load('Static/beep.mp3')
            ...
            if snake_y > 500 or snake_y < 0:
                game_over = True
                pygame.mixer.music.load('Static/explosion.wav')
                pygame.mixer.music.play()
